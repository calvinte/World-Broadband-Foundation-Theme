...
?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix container-12">
      ...
      <div class="grid-9"><?php print render($page['header']); ?><?php print render($page['dropdown']); ?></div>
    ...
    <div id="main-wrapper" class="clearfix"><div id="main" class="container-12">
      ...
      <?php if ($page['sidebar_first']): ?>
        <div id="sidebar-first" class="column sidebar grid-3"><div class="section">
